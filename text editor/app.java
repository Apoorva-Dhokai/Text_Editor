...
frmTextEditor.getContentPane().setLayout(new BorderLayout(0, 0));
    ...
    JLabel lblThisEditorIs = new JLabel("This Editor is designed in Java Swing as a project for Let's Grow More.");
    mnInfo.add(lblThisEditorIs);
    
    JSeparator separator = new JSeparator();
    mnInfo.add(separator);
    
    JLabel lblDevelopedByApoorva = new JLabel("Developed By DHOKAI APOORVA");
    mnInfo.add(lblDevelopedByApoorva);    
